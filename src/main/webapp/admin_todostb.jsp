			...
			<div  style="margin-left: auto; margin-right: auto" class="container">
			  ...
			  <div class="container" >
				  ...
				  <div class="row">
				    ...
				    <div class="col"><a href="../arquivosGrupo1/${ti.arquivo}" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-file-earmark-pdf-fill" viewBox="0 0 16 16">
				...
				<div>
				  ...
				  <br><br>
				  <div class="row">
				  	<div class="col"> <a href="aceitar.jsp?id_trabalho=${ti.id_trabalho}" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
 						<path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
						</svg>
					</a></div>
				    <div class="col"> <a href="recusar.jsp?id_trabalho=${ti.id_trabalho}" class="btn btn-danger" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
