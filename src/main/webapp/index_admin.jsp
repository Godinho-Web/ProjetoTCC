...
=======
				  ...
				  <!--	<input type="submit" value="Aceitar"/> -->
				  	 <button class="btn btn-success" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
				  	...
				  	<div class="col">
				  <!--  <div class="col"><input type="button" value="Recusar"/></div> -->
				  <button class="btn btn-danger" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
