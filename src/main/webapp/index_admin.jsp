			...
			<div  style="margin-left: auto; margin-right: auto" class="container">
			  ...
			  <div class="container" >
				...
				<div>
				  ...
				  <br><br>
				  <div class="row">
				   <!--	<div class="col"><a href="aceitar.jsp?id_trabalho=${ti.id_trabalho}" ></a></div> -->
				  <!--  <div class="col"><input type="button" value="Recusar"/></div> -->
				  	<div class="col">
				  <!--	 -->
				  	 <a href="aceitar.jsp?id_trabalho=${ti.id_trabalho}" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
